...
from pdf_extractor.utils.utils import (
    pdf_2_image,
    is_possible_NO_box,
    is_possible_signer_box,
    is_possible_date_box,
    is_possible_date_text,
    is_possible_NO_text,
    is_possible_signer_text,
)
...
class PDFExtractor:
    ...
    def extract(self, pdf_path: str, target_shape=(20, 1), confidence_threshold=0.7):
        ...
        for idx, image_path in enumerate(image_paths):
            ...
            page_result = self._extract_a_page(
                image, target_shape, confidence_threshold
            )
    ...
    def gather_all_page_results(self, page_result: list):
        ...
        for page_id, res in enumerate(page_result):
            if (
                page_id != 0
            ):  # pages which are other than 0 do not have date, and NO info
                res[NO] = []
                res[DATE] = []
