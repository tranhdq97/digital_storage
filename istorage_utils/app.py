...
FONT_DOCUMENT_HEADLINE_NOT_BOLD = Font(name="Times New Roman", size=14, bold=False)
FONT_HEADER_ITALIC = Font(name="Times New Roman", size=13, italic=True, bold=True)
FONT_HEADER_ITALIC_NOT_BOLD = Font(
    name="Times New Roman", size=13, italic=True, bold=False
)
...
def make_mucluc(xl_file_name, data):
    ...
    ws.merge_cells("B" + str(start_row_of_table) + ":D" + str(start_row_of_table))
    ws.merge_cells("E" + str(start_row_of_table) + ":I" + str(start_row_of_table))
    ws.merge_cells("J" + str(start_row_of_table) + ":K" + str(start_row_of_table))
    ws.merge_cells("L" + str(start_row_of_table) + ":M" + str(start_row_of_table))
    ws.merge_cells("O" + str(start_row_of_table) + ":P" + str(start_row_of_table))
    ...
    for idx in range(len_data):
        ...
        ws.merge_cells("B" + str(row_id) + ":D" + str(row_id))
        ws.merge_cells("E" + str(row_id) + ":I" + str(row_id))
        ws.merge_cells("J" + str(row_id) + ":K" + str(row_id))
        ws.merge_cells("L" + str(row_id) + ":M" + str(row_id))
        ws.merge_cells("O" + str(row_id) + ":P" + str(row_id))
    ...
    ws.merge_cells("A" + str(end_row_of_table + 1) + ":P" + str(end_row_of_table + 2))

    start_row_of_footer = end_row_of_table + 3

    ws.merge_cells("A" + str(start_row_of_footer) + ":P" + str(start_row_of_footer))
    ...
    ws.merge_cells(
        "A" + str(start_row_of_footer + 1) + ":P" + str(start_row_of_footer + 1)
    )
    ...
    ws.merge_cells(
        "A" + str(start_row_of_footer + 2) + ":P" + str(start_row_of_footer + 3)
    )

    ws.merge_cells(
        "L" + str(start_row_of_footer + 4) + ":P" + str(start_row_of_footer + 4)
    )
    ...
    ws.merge_cells(
        "A" + str(start_row_of_footer + 5) + ":P" + str(start_row_of_footer + 5)
    )

    ws.merge_cells(
        "L" + str(start_row_of_footer + 6) + ":P" + str(start_row_of_footer + 6)
    )
    ...
    ws.merge_cells(
        "L" + str(start_row_of_footer + 7) + ":P" + str(start_row_of_footer + 7)
    )
