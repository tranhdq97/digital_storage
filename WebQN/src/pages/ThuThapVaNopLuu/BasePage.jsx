...
const FIELDS_TABLE = [
    { title: "Tên biên bản", key: "name", width: "150%" },
    { title: "Ngày biên bản", key: "date", width: "100%" },
    { title: "Cơ quan / Đơn vị lập biên bản", key: "organ", width: "100%" },
            ...
            <div className="mt-[16px] mx-[24px] flex ">
                <div className="w-[11.11111%] px-[5px]">
                    <Input
                        allowClear
                        name="title"
                        placeholder="Tìm kiếm tên biên bản"
