...
const TimKiemVaDangKyMuonVanBan = () => {
	...
	const handleSearch = (search) => {
		const fetchData = () => {
			setSearching(true);
			navigate("/quan-li-thong-tin-khai-thac/tim-kiem-va-dang-ky-muon-van-ban?search=" + searchTerm)
			setTimeout(async () => {
	...
	const viewDocument = (idFile, idDoc) => {
		navigate("/quan-li-thong-tin-khai-thac/tim-kiem-va-dang-ky-muon-van-ban/" + idFile + "/" + idDoc)
	}
...
export default TimKiemVaDangKyMuonVanBan;
